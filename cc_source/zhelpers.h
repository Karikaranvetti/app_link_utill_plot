   ...
   #include <iostream>
    ...
    s_send (zmq::socket_t & socket, const std::string & string) {
     ...
     try {
        ...
        } catch (zmq::error_t& error) {  // added by alexv 2014-11-11
...
//    94 //
   ...
   s_clock (void)
   {
       ...
       //int64_t i64t1=tv.tv_sec * 1000LL, i64t2=tv.tv_usec / 1000LL, i64t3=(int64_t) (tv.tv_sec * 1000LL + tv.tv_usec / 1000LL);
       //std::cout << "tv.tv_sec * 1000LL=" << i64t1 << ", tv.tv_usec/1000LL=" << i64t2 << ", ret=" << i64t3 << std::endl;
       return (int64_t) (tv.tv_sec * 1000LL + tv.tv_usec / 1000LL); //bgv
   #endif
   }
